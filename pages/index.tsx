...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://api.themoviedb.org/3/search/movie?api_key=57585d1e9624443028acab0f0647ea14&language=ja-JP&include_adult=false&region=JP&query=${word}&page=${page}`)
      .then((res) => res.json())
      .then((json) => {
        if (json) {
